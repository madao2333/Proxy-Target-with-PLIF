...
def _lo_user_installation_arg(user_profile: str) -> str:
    # LibreOffice on Windows rejects file://C:\... and may report a damaged
    # bootstrap.ini. Path.as_uri() produces the required file:///C:/... form.
    return "-env:UserInstallation=" + Path(user_profile).resolve().as_uri()
...
def convert_to_pdf(
    ...
    cmd_pdf = [
        "soffice",
        _lo_user_installation_arg(user_profile),
        "--invisible",
        "--headless",
        "--norestore",
        "--convert-to",
